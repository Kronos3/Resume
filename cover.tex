...
\documentclass[]{alternate}          % Add 'print' as an option into the square bracket to remove colours from this template for printing. 
...
\entry
  ...
  {Ithaca, New York}
  {\jobtitle{Building maitainance assistant}\\
